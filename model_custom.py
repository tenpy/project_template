"""This file ``model_custom.py`` illustrates customization code for TeNPy simulations.
...
``simulation_custom.yml`` from the terminal like this::

    python -m tenpy -i model_custom simulation_custom.yml
"""
